...
import { Crown02Icon, Delete02Icon, LayoutTable01Icon } from '@hugeicons/core-free-icons'
...
export default function TemplateSelector({ templates, onApply, translations }: Props) {
	...
	return (
		<div className="mb-6">
			<div className="flex items-center gap-2 mb-3">
				<HugeiconsIcon icon={LayoutTable01Icon} size={16} className="text-default-500" />
				<span className="text-sm font-semibold text-default-700">{translations.title}</span>
				{!canUse && (
