...
const ALPHA2_TO_NUMERIC: Record<string, number> = {
	...
	GL: 304, GD: 308, GT: 320, GN: 324, GW: 624, GY: 328, HT: 332, VA: 336,
	HN: 340, HK: 344, HU: 348, IS: 352, IN: 356, ID: 360, IR: 364, IQ: 368,
	...
	NG: 566, MK: 807, NO: 578, OM: 512, PK: 586, PW: 585, PS: 275, PA: 591,
	...
	SR: 740, SZ: 748, SE: 752, CH: 756, SY: 760, TW: 158, TJ: 762, TZ: 834,
...
const buildNumericMap = (data: Record<string, number>): Record<number, number> =>
	Object.entries(data).reduce<Record<number, number>>((acc, [alpha2, count]) => {
