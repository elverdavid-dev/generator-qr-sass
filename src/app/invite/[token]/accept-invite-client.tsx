			...
			<div className="bg-content1 border border-divider rounded-3xl p-10 max-w-sm w-full text-center flex flex-col items-center gap-5">
				...
				<div>
					...
					<p className="text-default-500 text-sm">
						Ahora eres parte del equipo de <span className="font-semibold text-foreground">{ownerName}</span>. Serás redirigido al dashboard en unos segundos.
					</p>
				</div>
				<Button color="primary" radius="full" className="w-full" onPress={() => router.push('/dashboard')}>
					Ir al dashboard →
				</Button>
			</div>
		</section>
