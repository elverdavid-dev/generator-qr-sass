...
import { createWebhook, deleteWebhook, toggleWebhook } from '@/features/webhooks/services/mutations/webhook-actions'
...
describe('createWebhook', () => {
	...
	it('returns error when unauthenticated', async () => {
		...
		const result = await createWebhook({ name: 'My Hook', url: 'https://example.com/hook' })
	...
	it('returns error on DB insert failure', async () => {
		...
		const result = await createWebhook({ name: 'Hook', url: 'https://example.com' })
