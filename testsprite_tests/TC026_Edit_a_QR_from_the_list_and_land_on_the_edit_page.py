...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided credentials into the email and password fields, then click the 'Iniciar sesión' button to attempt login.
        ...
        # -> Click the 'Iniciar sesión' submit button again (element [448]) to retry login and trigger the dashboard redirect.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/section/section/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
