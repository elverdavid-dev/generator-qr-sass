...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /register (http://localhost:3000/register) to open the registration page so the registration form can be filled.
        await page.goto("http://localhost:3000/register")
        
        # -> Fill the email field (index 508) with yabog75731@qvmao.com, fill the password field (index 518) with ValidPassw0rd!, then click the Registrarse button (index 524) to submit the form.
