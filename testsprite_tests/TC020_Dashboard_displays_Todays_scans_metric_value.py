...
async def run_test():
    ...
    try:
        ...
        # -> Type the email into the email field (index 502).
        ...
        # -> Retry clicking the 'Iniciar sesión' button to attempt login again, then wait up to 5 seconds for a redirect to '/dashboard' and check for the 'Today' text and 'Today's scans' metric.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/main/section/section/form/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        ...
        assert await frame.locator("xpath=//*[contains(., \"Today's scans\")]\").nth(0).is_visible(), "Expected 'Today's scans' to be visible"
